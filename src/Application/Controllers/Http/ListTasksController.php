...
class ListTasksController implements ListTasksControllerInterface
{
    /**
     * @var ListTasksActionInterface
     */
    private ListTasksActionInterface $action;

    public function __construct(ListTasksActionInterface $action)
    {
        $this->action = $action;
    }
